...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "Xun3";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "XUN";
    ...
    const std::string daemonName = "ultranoted";
    ...
    const std::string coinName = "UltraNote";

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "https://discord.gg/Dhkjzz5";
